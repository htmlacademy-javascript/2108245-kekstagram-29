...
const INVALID_HASHTAG_NAME =
  'Хеш-тег начинается с #, длиной не более 20 символов и может состоять только из букв и цифр';
...
const isHashtagTooMany = (value) =>
  createHashtags(value).length <= HASHTAGS_MAX_COUNT;
